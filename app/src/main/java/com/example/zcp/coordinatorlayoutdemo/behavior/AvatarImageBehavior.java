...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    private static final float START_MULTIPLE = 2f;
    ...
    public AvatarImageBehavior(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mstartMultiple = a.getFloat(R.styleable.AvatarImageBehavior_startMultiple, START_MULTIPLE);
            a.recycle();
        }
        if (mstartMultiple < 1)
            mstartMultiple = START_MULTIPLE;
    }
    ...
    private void maybeInitProperties(CircleImageView child, View dependency) {
        ...
        if (mChangeBehaviorPoint == 0) {
            mChangeBehaviorPoint = (child.getHeight() - mCustomFinalHeight) / (mstartMultiple * (mStartYPosition - mFinalYPosition));
        }
    }
}
