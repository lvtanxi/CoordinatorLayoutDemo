 ...
 * Description:
 */
public class MiezuAct extends AppCompatActivity {
    public static void startMiezuAct(Activity activity) {
        activity.startActivity(new Intent(activity, MiezuAct.class));
    }
